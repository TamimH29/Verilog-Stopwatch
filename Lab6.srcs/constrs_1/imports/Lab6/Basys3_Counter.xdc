...
set_property PACKAGE_PIN V2 [get_ports {modein[0]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {modein[0]}]
set_property PACKAGE_PIN T3 [get_ports {modein[1]}]					
	set_property IOSTANDARD LVCMOS33 [get_ports {modein[1]}]
...
set_property PACKAGE_PIN W19 [get_ports startstop]						
